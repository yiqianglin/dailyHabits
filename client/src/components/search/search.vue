<template>
  <div v-show="show" :class="{mini: options && options.mini, full: !options || !options.mini, 'bar-tab': searchInput && tabIdx > -1, 'bar-tag-tab': searchInput && tabIdx === 0 && tagsList && tagsList.length}" class="search-container">
      ...
      <div class="search-detail">
        ...
        <div v-show="searchInput && tabIdx > -1">
          ...
          <div v-show="tabIdx === 0 || (tabIdx > 0 && curTab.list && curTab.list.length)" class="loading">
            ...
            {{ (tabIdx === 0 && mixDataItem.loaded) || (tabIdx > 0 && curTab.loaded) ? '更多专业内容，陆续更新' : '正在加载更多' }}
          </div>
        </div>
